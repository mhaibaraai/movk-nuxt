 ...
 */
export function introspectSchema(schema: z.ZodType, mapping: AutoFormControls, parentPath?: string): AutoFormField[] {
  ...
  if (type === 'object') {
    ...
    for (const key of Object.keys(shape)) {
      ...
      result.push(...introspectSchema(child, mapping, path))
    }
    return result
  }
