...
import type { AutoFormControl, AutoFormControls, AutoFormControlsMeta, AutoFormField } from '../types'
...
function extractSchemaInfo(schema: z.ZodType) {
  ...
  for (const node of iterateZodChain(schema)) {
    console.log('extractSchemaInfo', node, node.meta())
    // 收集 meta
...
export function introspectSchema(schema: z.ZodType, parentPath?: string): AutoFormField[] {
  ...
  console.log('introspectSchema', mergedMeta.props)
...
export function resolveControlMeta(entry: AutoFormField, mapping: AutoFormControls): AutoFormControlsMeta {
  ...
  console.log('resolveControlMeta', meta.props)
  return {
    type: meta.type,
