...
import type { AutoFormControl, AutoFormControls, AutoFormField, AutoFormFieldContext, AutoFormLayoutConfig, AutoFormMergeMeta } from '../types/auto-form'
...
function handleLayoutField(
  ...
  if (!layoutConfig?.fields || typeof layoutConfig.fields !== 'object') {
    return []
  }
  ...
  const layoutField: AutoFormField = {
    ...
    meta: {
      type: 'layout',
      virtual: true,
      component: layoutConfig.component
    },
    decorators: {},
    layoutConfig,
    children: []
