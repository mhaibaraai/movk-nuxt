import type { ButtonProps, CheckboxProps, DropdownMenuProps, IconProps, ModalProps, PaginationProps, SelectProps, TableColumn, TableData, TableProps, TooltipProps } from '@nuxt/ui'
...
export interface DataTableActionConfirmProps extends OmitByKey<ModalProps, 'title' | 'open' | 'defaultOpen' | 'dismissible'> {
  title?: string
  type?: import('../shared').SemanticColor
  icon?: IconProps['name']
  dismissible?: boolean
  description?: string
  confirmText?: string
