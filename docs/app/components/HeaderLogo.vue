...
<template>
  <div class="flex items-center gap-2" aria-label="Site Logo">
    <UContextMenu :items="items">
      <NuxtLink :to="header.to" class="flex items-end gap-2 font-bold text-xl text-highlighted min-w-0 outline-primary/25 focus-visible:outline-3 shrink-0 rounded-md p-1 -ms-1" aria-label="Movk Nuxt">
