...
The `@theme` injected by the module comes before your project CSS, so your own `@theme` can still override `--font-sans`. To control the font entirely from your own CSS, leave `movk.theme.font` unset:
