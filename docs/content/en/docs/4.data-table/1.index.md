...
Besides the named slots above, dynamic slots named after column ids are supported: `#<column>-header`, `#<column>-cell` and `#<column>-footer`. See [Columns · Header and Cell Slots](/docs/data-table/columns#header-and-cell-slots).
