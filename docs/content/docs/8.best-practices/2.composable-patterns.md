...
seo:
  ...
  description: Layered composable design for Movk Nuxt apps — thin view layer, business logic in composables, useAsyncData key management and multi-endpoint aggregation.
---
  ...
  - label: "app/"
    children:
      ...
      - label: "composables/"
        children:
          - label: "useApi.ts"
            description: "自定义 useFetch 封装（仅 app 侧）"
          - label: "modules/"
            description: "业务 composables"
            children:
              - label: "user/"
                children:
                  - label: "useUserList.ts"
                    description: "用户列表页逻辑"
                  - label: "useUserDetail.ts"
                    description: "用户详情页逻辑"
                  - label: "useUserForm.ts"
                    description: "用户表单（新增/编辑）逻辑"
              - label: "order/"
                children:
                  - label: "useOrderList.ts"
                  - label: "useOrderDetail.ts"
                  - label: "useOrderActions.ts"
                    description: "订单操作（审批、取消等）"
      - label: "pages/"
        children:
          - label: "users/"
            children:
              - label: "index.vue"
                description: "用户列表页（薄 View 层）"
              - label: "[id].vue"
                description: "用户详情页"
      - label: "components/"
        children:
          - label: "user/"
            children:
              - label: "UserTable.vue"
              - label: "UserForm.vue"
              - label: "UserSearchBar.vue"
      - label: "plugins/"
        children:
          - label: "api.ts"
            description: "$fetch 实例注册"
---
::
