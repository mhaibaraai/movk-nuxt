...
<template>
  <div class="absolute left-0 top-0 z-10 flex">
    <div class="ml-4 mt-4 flex flex-1 items-center">
      <svg viewBox="0 0 256 256" fill="currentColor" class="mr-2 text-primary text-xl">
        <circle cx="128" cy="128" r="120" fill="var(--ui-primary)" />
        <g fill="white">
